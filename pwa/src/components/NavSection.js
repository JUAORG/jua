...
import { Box, List, Collapse, Typography, ListItemText, ListItemIcon, ListItemButton } from '@mui/material';
...
export default function NavSection({ navConfig, ...other }) {
  ...
  return (
    <Box {...other}>
      ...
      <Typography variant="p" component="p" sx={{ fontSize: '11px', textAlign: 'center' }}>
